-- CH_VACC_C_DP3
-- Percentage of children aged 12-23 months who have received DPT3 vaccination

-- Denominator is all children aged 12-23 months who are alive
-- Numerator is all children aged 12-23 months who are alive and have received the vaccination
...
, SUM(	
	CASE WHEN 
		...
		(r01_wmn.v008::Integer - r21_kids.b3::Integer ) between 12 and 23
		AND 
...
, SUM(
	CASE WHEN 
		...
		r21_kids.b5::Integer = 1
		AND
		r43.h3::Integer BETWEEN 1 and 7 --inclusive
		AND 
		r43.h5::Integer BETWEEN 1 and 7 -- inclusive
		AND
		r43.h7::Integer BETWEEN 1 and 7 -- inclusive
