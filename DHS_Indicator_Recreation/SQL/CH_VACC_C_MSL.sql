-- CH_VACC_C_MSL
-- Percentage of children aged 12-23 months who have received measles vaccination
...
, SUM(
	CASE WHEN 
		...
		r21_kids.b5::Integer = 1
		AND
		(r43.h9::Integer BETWEEN 1 and 7 --inclusive
		OR 
		(r95.data->>'s506mr')::Integer in (1,2,3))
