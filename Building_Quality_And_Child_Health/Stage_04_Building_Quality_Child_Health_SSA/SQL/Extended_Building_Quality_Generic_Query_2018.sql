...
, (SELECT value_desc from dhs_survey_specs.dhs_value_descs where col_name='HV219' AND surveyid=r0.surveyid AND value=hv219 AND value_type='ExplicitValue') as hv219_desc_hh_head_sex
...
, (SELECT value_desc from dhs_survey_specs.dhs_value_descs where col_name='HV252' AND surveyid=r0.surveyid AND value=hv252 AND value_type='ExplicitValue') as hv252_desc_frequency_of_smoking
