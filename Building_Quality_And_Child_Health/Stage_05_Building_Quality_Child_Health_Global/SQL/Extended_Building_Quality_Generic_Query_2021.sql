...
, (SELECT max(value_desc) from dhs_survey_specs.dhs_value_descs where col_name='HV025' AND surveyid=r0.surveyid AND value=hv025 AND value_type='ExplicitValue') as hv025_desc_resid_type
, r0.hv026 as "hv026_resid_place"
, (SELECT max(value_desc) from dhs_survey_specs.dhs_value_descs where col_name='HV026' AND surveyid=r0.surveyid AND value=hv026 AND value_type='ExplicitValue') as hv026_desc_resid_place

, r0.hv040 as "hv040_cluster_alt_m"

, r2.hv201 as "hv201_watersrc"
-- all value descs are selected using a MAX aggregation just because a few surveys have been duplicate-loaded to the value descriptions
-- table by mistake
...
, (SELECT max(value_desc) from dhs_survey_specs.dhs_value_descs where col_name='HV201' AND surveyid=r0.surveyid AND value=hv201 AND value_type='ExplicitValue') as hv201_desc_watersrc
...
, (SELECT max(value_desc) from dhs_survey_specs.dhs_value_descs where col_name='HV213' AND surveyid=r0.surveyid AND value=hv213 AND value_type='ExplicitValue') as hv213_desc_flooring
...
, r2.hv219 as "hv219_hh_head_sex"
, (SELECT max(value_desc) from dhs_survey_specs.dhs_value_descs where col_name='HV219' AND surveyid=r0.surveyid AND value=hv219 AND value_type='ExplicitValue') as hv219_desc_hh_head_sex
...
, (SELECT max(value_desc) from dhs_survey_specs.dhs_value_descs where col_name='HV226' AND surveyid=r0.surveyid AND value=hv226 AND value_type='ExplicitValue') as hv226_desc_cooking_fuel
, r2.hv238 as "hv238_nhh_sharing_toilet"

, r2.hv239 as "hv239_cooking_appliance"
, (SELECT max(value_desc) from dhs_survey_specs.dhs_value_descs where col_name='HV239' AND surveyid=r0.surveyid AND value=hv239 AND value_type='ExplicitValue') as hv239_desc_cooking_appliance
, r2.hv240 as "hv240_ventilation"
, (SELECT max(value_desc) from dhs_survey_specs.dhs_value_descs where col_name='HV240' AND surveyid=r0.surveyid AND value=hv240 AND value_type='ExplicitValue') as hv240_desc_ventilation
...
, (SELECT max(value_desc) from dhs_survey_specs.dhs_value_descs where col_name='HV270' AND surveyid=r0.surveyid AND value=hv270 AND value_type='ExplicitValue') as hv270_desc_wealthquint
, r2.hv271 as "hv271_wealthscore"
, r2.hv252 as "hv252_frequency_of_smoking"
, (SELECT max(value_desc) from dhs_survey_specs.dhs_value_descs where col_name='HV252' AND surveyid=r0.surveyid AND value=hv252 AND value_type='ExplicitValue') as hv252_desc_frequency_of_smoking
, r2.hv253 as "hv253_irs_in_last_yr"
, r1.hv106 as "hv106_head_ed_lvl"
, (SELECT max(value_desc) from dhs_survey_specs.dhs_value_descs where col_name='HV106' AND surveyid=r0.surveyid AND value=hv106 AND value_type='ExplicitValue') as hv106_desc_head_ed_lvl
, r1.hv109 as "hv109_head_ed_attain"
, (SELECT max(value_desc) from dhs_survey_specs.dhs_value_descs where col_name='HV109' AND surveyid=r0.surveyid AND value=hv109 AND value_type='ExplicitValue') as hv109_desc_head_ed_attain
, r1.hv115 as "hv115_head_marital_status"
, (SELECT max(value_desc) from dhs_survey_specs.dhs_value_descs where col_name='HV115' AND surveyid=r0.surveyid AND value=hv115 AND value_type='ExplicitValue') as hv115_desc_head_marital
...
, COALESCE(
	(SELECT max(value_desc) from dhs_survey_specs.dhs_value_descs where col_name='V717' AND surveyid=r0.surveyid AND value=wmn_occ_grp AND value_type='ExplicitValue')
	,  (SELECT max(value_desc) from dhs_survey_specs.dhs_value_descs where col_name='V705' AND surveyid=r0.surveyid AND value=partner_occ_grp AND value_type='ExplicitValue') 
...
r0.surveyid::Integer = {SURVEYID} --in (282,323,330,332,337,338,395,399,437,451,473,481,484)
