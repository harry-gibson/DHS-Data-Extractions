...
, CASE WHEN tblfever.h22::Integer = 1 AND (
 tblfever.h32s::Integer=1 OR tblfever.h32q::Integer=1 OR tblfever.h32r::Integer=1 OR tblfever.h32f::Integer=1 OR tblfever.h32g::Integer=1 OR tblfever.h32h::Integer=1 OR tblfever.h32i::Integer=1 OR tblfever.h32m::Integer=1 OR tblfever.h32b::Integer=1 OR tblfever.h32a::Integer=1 OR tblfever.h32d::Integer=1 OR tblfever.h32c::Integer=1 OR tblfever.h32p::Integer=1 OR tblfever.h32e::Integer=1 OR tblfever.h32l::Integer=1 OR tblfever.h32o::Integer=1 OR tblfever.h32j::Integer=1 OR tblfever.h32k::Integer=1 OR tblfever.h32t::Integer=1 OR tblfever.h32n::Integer=1
) THEN 1 ELSE 0 END AS any_treat
, CASE WHEN tblfever.h22::Integer = 1 AND (
 tblfever.h32s::Integer=1 OR tblfever.h32f::Integer=1 OR tblfever.h32g::Integer=1 OR tblfever.h32h::Integer=1 OR tblfever.h32i::Integer=1 OR tblfever.h32b::Integer=1 OR tblfever.h32a::Integer=1 OR tblfever.h32d::Integer=1 OR tblfever.h32c::Integer=1 OR tblfever.h32e::Integer=1
 ) THEN 1 ELSE 0 END AS public_treat
FROM dhs_data_tables."REC43" tblfever
) fever
ON 
r21.surveyid = fever.surveyid AND r21.caseid = fever.caseid AND r21.BIDX = fever.HIDX
INNER JOIN
...
WHERE r21.surveyid::Integer=396 AND r21.b5 ::Integer=1 AND r21.b8::Integer<=5
GROUP BY r01.surveyid, r01.caseid, r01.v001, r01.v024, clust.latnum, clust.longnum, h0.hv025, r11.v190
ORDER BY r01.surveyid::Integer, r01.v024::Integer, r01.v001::Integer, r01.caseid