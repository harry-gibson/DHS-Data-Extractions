...
- [input](input/) contains a question-mapping file in which the questions have been appropriately flagged. This can be used as input to the SQL-generation workbench
